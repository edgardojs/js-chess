...
function ClickedSquare(pageX, pageY) {
	...
	console.log("ClickedSquared at " + pageX + ", " + pageY);
...
function MakeUserMove() {
	if(UserMove.from != SQUARES.NO_SQ && UserMove.to != SQUARES.NO_SQ) {
		...
		Deselect(UserMove.from);
		Deselect(UserMove.to);
...
function AddGUIPiece(sq, pce) {
	...
	var pieceFileName = "img/" + SideChar[PieceCol[pce]] + PceChar[pce].toUpperCase() + ".png";
...
function StartSearch() {
	...
	SearchController.depth = $("#DepthChoice").val();
	var t = $.now();
